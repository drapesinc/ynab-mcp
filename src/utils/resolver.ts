...
// Cache structure: profile -> budget -> entity type -> name -> id
...
const accountCache: Map<string, Map<string, CacheEntry>> = new Map();
const categoryCache: Map<string, Map<string, CacheEntry>> = new Map();
const payeeCache: Map<string, Map<string, CacheEntry>> = new Map();

function getCacheKey(profile: string, budgetId: string): string {
